...
export const LETTER_TONE_DETAILS: Record<WritingDeskLetterTone, { label: string; prompt: string }> = {
  formal: {
    label: 'Formal',
    prompt: 'Write with formal parliamentary etiquette: respectful, precise, and structured with clear paragraphs.',
  },
  polite_but_firm: {
    label: 'Polite but firm',
    prompt: 'Maintain polite language while firmly emphasising the urgency and expectation of action.',
  },
  empathetic: {
    label: 'Empathetic',
    prompt: 'Adopt a compassionate tone that centres the human impact while remaining respectful and solution-focused.',
  },
  urgent: {
    label: 'Urgent',
    prompt: 'Convey urgency and seriousness without being aggressive. Keep sentences direct and compelling.',
  },
  neutral: {
    label: 'Neutral',
    prompt: 'Use clear, matter-of-fact language that presents evidence and requests without emotional colouring.',
  },
  highly_persuasive: {
