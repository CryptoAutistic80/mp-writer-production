...
export const LETTER_RESPONSE_SCHEMA = {
  ...
  properties: {
    ...
    references: {
      type: 'array',
      description:
        'List of full, properly formatted URLs used as references. URLs must be complete with protocol (https://) and should NOT be percent-encoded - use plain characters for special symbols like # : ~ = in URL fragments.',
      items: {
        type: 'string',
        description:
